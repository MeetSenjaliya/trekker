...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // No `images` on either object: that lets `opengraph-image.tsx` supply the
  // generated card (an explicit `images` here would win over the file), and
  // Next fills `twitter.images` from the resolved Open Graph ones.
  return {
    title,
    description,
