          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="relative group">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-1.5 bg-[#090a0f]/20 border border-white/10 rounded-full text-sm text-white placeholder-blue-200/30 focus:outline-hidden focus:ring-1 focus:ring-blue-400/50 focus:bg-[#090a0f]/40 transition-all w-48 hover:w-64 duration-300"
              />
            </div>
          ...
          >
            ...
            <div className="flex flex-col space-y-2 p-4">
              <div className="relative mb-4">
                ...
                <input type="text" placeholder="Search..." className="w-full pl-10 pr-4 py-2.5 bg-black/20 border border-white/10 rounded-lg text-sm text-white placeholder-white/40 focus:outline-hidden focus:ring-1 focus:ring-blue-400/50" />
              </div>
